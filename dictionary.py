...
print('Slovník rainbowOperators')
print('----------------------------------------------------------------------------------------------------------------------------------------------------')
print('operator              nickname              name                   roles                            speed              armor              difficulty')
print('----------------------------------------------------------------------------------------------------------------------------------------------------')
y = 1
z = 0
c = 0
operators = ['operator1', 'operator2', 'operator3']
for x in rainbowOperators:
  #print(operators[y-1], '       ', rainbowOperators[operators[y-1]]['nickname'], '       ', rainbowOperators[operators[y-1]]['name'])
  print('%s %20s %17s %45s %10d %19d %22d' % (operators[y-1], rainbowOperators[operators[y-1]]['nickname'], rainbowOperators[operators[y-1]]['name'], rainbowOperators[operators[y-1]]['role'], rainbowOperators[operators[y-1]]['speed'], rainbowOperators[operators[y-1]]['armor'], rainbowOperators[operators[y-1]]['difficulty']))
  y+=1
print('----------------------------------------------------------------------------------------------------------------------------------------------------')